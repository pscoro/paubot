...
const infoEmbed = new Discord.MessageEmbed()
	...
	.addFields(
		{ name: 'What is worldbuilding?', value: 'Wikipedia defines it as \'Worldbuilding is the process of constructing an imaginary world, sometimes associated with a whole fictional universe. Developing an imaginary setting with coherent qualities such as a history, geography, and ecology is a key task for many science fiction or fantasy writers.\'' },
        ...
        { name: 'What if I don\'t like something that someone else made', value: 'All users must agree to the rules before using wb commands, details on fairplay are provided there. If you think someone elses facet is off-topic or ill-spirited consider flagging it for review with %wbflag [id] [description of request] whereupon you and everyone can use %wbreview to review and vote upon these requests. If a user is blatantly breaking the worldbuilding rules, use %wbreport [user] [reason] to send the bot owner a personalized moderation request, at which point will review whether the user broke any rules and possibly remove his wb permissions.' },
